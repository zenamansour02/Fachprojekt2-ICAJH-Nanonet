#!/bin/bash
# ============================================================
# Phase 2: ICA-JH 13-node gateway experiment  --  ICAJH13.topo.sh
# ============================================================
# Topology: 13 nodes — core/gateway (0-4), sources (11-14), receivers (21-24)
# TE demands:
#   11->4 : waypoint=1  (encap seg6 segs node_1)
#   12->4 : waypoint=1  (encap seg6 segs node_1)
#   13->4 : waypoint=2  (encap seg6 segs node_2)
#   14->4 : direct      (no SRv6)
#   => ICA-JH MLU = 1.0
# Measurement flows: nuttcp 11->21, 12->22, 13->23, 14->24 (TIME=120s, NSTREAMS=8)
# Weights: HeurOSPF w_core=1 (cost=1000), w_dest=4 (cost=4000), w_recv=1
# ============================================================
# Loopback assignments (deterministic; regenerate with build.py on Linux):
...
# 22 loop: fc00:2:0:b::1/64
# 23 loop: fc00:2:0:c::1/64
# 24 loop: fc00:2:0:d::1/64
# Link IDs: (0,1)=1, (1,2)=2, (2,3)=3, (0,4)=4, (1,4)=5, (2,4)=6, (3,4)=7
#           (11,0)=8, (12,0)=9, (13,0)=a, (14,0)=b
#           (4,21)=c, (4,22)=d, (4,23)=e, (4,24)=f
# ============================================================
...
ip netns exec 11 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:8::1 metric 5000 src fc00:2:0:1::1'
...
ip netns exec 11 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:8::1 metric 6000 src fc00:2:0:1::1'
ip netns exec 11 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:8::1 metric 6000 src fc00:2:0:1::1'
ip netns exec 11 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:8::1 metric 6000 src fc00:2:0:1::1'
ip netns exec 11 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:8::1 metric 6000 src fc00:2:0:1::1'
ip netns exec 11 bash -c 'ip -6 route add fc00:2:0:a::1 metric 1 table 1 src fc00:2:0:1::1 nexthop via fc00:42:0:8::1 encap seg6 mode inline segs fc00:2:0:2::1 weight 100'
...
ip netns exec 12 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:9::1 metric 5000 src fc00:2:0:8::1'
...
ip netns exec 12 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:9::1 metric 6000 src fc00:2:0:8::1'
ip netns exec 12 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:9::1 metric 6000 src fc00:2:0:8::1'
ip netns exec 12 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:9::1 metric 6000 src fc00:2:0:8::1'
ip netns exec 12 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:9::1 metric 6000 src fc00:2:0:8::1'
ip netns exec 12 bash -c 'ip -6 route add fc00:2:0:b::1 metric 1 table 1 src fc00:2:0:8::1 nexthop via fc00:42:0:9::1 encap seg6 mode inline segs fc00:2:0:2::1 weight 100'
...
ip netns exec 13 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:a::1 metric 5000 src fc00:2:0:4::1'
...
ip netns exec 13 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:a::1 metric 6000 src fc00:2:0:4::1'
ip netns exec 13 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:a::1 metric 6000 src fc00:2:0:4::1'
ip netns exec 13 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:a::1 metric 6000 src fc00:2:0:4::1'
ip netns exec 13 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:a::1 metric 6000 src fc00:2:0:4::1'
ip netns exec 13 bash -c 'ip -6 route add fc00:2:0:c::1 metric 1 table 1 src fc00:2:0:4::1 nexthop via fc00:42:0:a::1 encap seg6 mode inline segs fc00:2:0:5::1 weight 100'
...
ip netns exec 14 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:b::1 metric 5000 src fc00:2:0:9::1'
...
ip netns exec 14 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:b::1 metric 6000 src fc00:2:0:9::1'
ip netns exec 14 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:b::1 metric 6000 src fc00:2:0:9::1'
ip netns exec 14 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:b::1 metric 6000 src fc00:2:0:9::1'
ip netns exec 14 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:b::1 metric 6000 src fc00:2:0:9::1'
...
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:4::1 metric 4000 src fc00:2:0:6::1'
...
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:4::1 metric 5000 src fc00:2:0:6::1'
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:4::1 metric 5000 src fc00:2:0:6::1'
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:4::1 metric 5000 src fc00:2:0:6::1'
ip netns exec 0 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:4::1 metric 5000 src fc00:2:0:6::1'
...
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:5::1 metric 4000 src fc00:2:0:2::1'
...
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:5::1 metric 5000 src fc00:2:0:2::1'
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:5::1 metric 5000 src fc00:2:0:2::1'
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:5::1 metric 5000 src fc00:2:0:2::1'
ip netns exec 1 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:5::1 metric 5000 src fc00:2:0:2::1'
...
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:6::1 metric 4000 src fc00:2:0:5::1'
...
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:6::1 metric 5000 src fc00:2:0:5::1'
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:6::1 metric 5000 src fc00:2:0:5::1'
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:6::1 metric 5000 src fc00:2:0:5::1'
ip netns exec 2 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:6::1 metric 5000 src fc00:2:0:5::1'
...
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:7::1/64 via fc00:42:0:7::1 metric 4000 src fc00:2:0:3::1'
...
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:a::1/64 via fc00:42:0:7::1 metric 5000 src fc00:2:0:3::1'
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:b::1/64 via fc00:42:0:7::1 metric 5000 src fc00:2:0:3::1'
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:c::1/64 via fc00:42:0:7::1 metric 5000 src fc00:2:0:3::1'
ip netns exec 3 bash -c 'ip -6 ro ad fc00:2:0:d::1/64 via fc00:42:0:7::1 metric 5000 src fc00:2:0:3::1'
...
# Commands for namespace 4 (gateway)
...
# Commands for namespace 21 (receiver for demand 11->21)
...
# Commands for namespace 22 (receiver for demand 12->22)
...
# Commands for namespace 23 (receiver for demand 13->23)
...
# Commands for namespace 24 (receiver for demand 14->24)
